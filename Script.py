...
# ⚠️ Please don't change our credits 𝚃𝙷𝙰𝙽𝙺𝚂 𝚃𝙾 & 𝙳𝙴𝚅 👇🏻
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ ʟᴏᴠᴇ❤: <a href=https://t.me/Mister_Ash>❤</a>
...
Merry Christmas ❄️ and Happy New Year 🎇</b>"""
    ...
    OLD_ALRT_TXT = """वो मैसेज बहुत पुराना हो गया है। वापस लिख कर भेजना होगा....🥲🥲"""

    TOP_ALRT_MSG = """♻️ ᴄʜᴇᴄᴋɪɴɢ ꜰɪʟᴇ ᴏɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ... ♻️"""

    MVE_NT_FND = """<b>वो मूवी हमारे डेटाबेस में नई है....😶</b> """
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    I_CUDNT = """हमे ऐसी कोई मूवी नई मिली....🥺."""

    I_CUD_NT = """{} लगता हे मूवी नाम गलत लिखा है सही नाम चुने....😉"""
    
    CUDNT_FND = """{} लगता हे मूवी नाम गलत लिखा है सही नाम चुने....😉"""
